...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"assets/scripts/Utils/PubSub.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(PublisherSubscriber, [{
    key: "addListener",
    value: function addListener(eventName, userFunction) {
    ...
    key: "removeListener",
    value: function removeListener(eventName, userFunction) {
      if (!this.eventDispatch[eventName]) {
        return;
      }

      var index = this.eventDispatch[eventName].findIndex(function (func) {
        return func === userFunction;
      });
    ...
    value: function fireEvent(eventName, event) {
      ...
      try {
        for (var _iterator = this.eventDispatch[eventName][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var _default = PublisherSubscriber;
exports.default = _default;
},{}],"../node_modules/random-number/index.js":[function(require,module,exports) {
void function(root){
...
function () {
  ...
  _createClass(View, [{
    ...
    value: function createImage(typesOfCars) {
      ...
      try {
        for (var _iterator = typesOfCars[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: function setTime(time) {
      var timeWrap = document.getElementById('time');
    ...
    value: function createGrid(amountPair, amountCard, typesOfCars) {
      ...
      while (index) {
        ...
        try {
          for (var _iterator2 = typesOfCars[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function randomCard() {
      ...
      cards.forEach(function (card) {
        var randomPos = (0, _randomNumber.default)(options);
        card.style.order = randomPos;
        var cof = 50;
        card.classList.add('transition-top');
        card.style.transitionDelay = "".concat((0, _randomNumber.default)(options) * cof, "ms");
      });
    }
  }]);
...
var _default = View;
exports.default = _default;
},{"../Utils/PubSub":"assets/scripts/Utils/PubSub.js","random-number":"../node_modules/random-number/index.js"}],"assets/scripts/Model/Model.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Model, [{
    ...
    key: "setOpenCards",
    value: function setOpenCards(cards) {
      var _this$openCards;

      (_this$openCards = this.openCards).push.apply(_this$openCards, _toConsumableArray(cards));
    }
    /**
     * @param {Object} card
     * @return {void}
    ...
    key: "setCurrentCard",
    value: function setCurrentCard(card) {
...
var _default = Model;
exports.default = _default;
},{"../Utils/PubSub":"assets/scripts/Utils/PubSub.js"}],"assets/scripts/Utils/Throttle.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Throttle, [{
    key: "delay",
    value: function delay(func, newDelay) {
...
exports.default = _default;
},{}],"assets/scripts/Controller/Controller.js":[function(require,module,exports) {
"use strict";
...
function () {
  function Controller(model, view, router) {
    ...
    this.view.event.addListener('selectCard', function (card) {
      ...
      if (!_this.model.currentCard.length) {
        _this.model.setCurrentCard(card);
      } else {
        var status = _this.compareCard(card);

        if (!status) {
          _this.view.isBlock = true;
          ...
          if (_this.model.currentCard.length < _this.model.getLevel().cardToCompare - 1) {
            _this.model.setCurrentCard(card);
  ...
  _createClass(Controller, [{
    ...
    key: "checkSelected",
    value: function checkSelected(card) {
    ...
    key: "compareCard",
    value: function compareCard(card) {
      var framework = card.framework;
      var lastFramework = this.model.currentCard[this.model.currentCard.length - 1].framework;
    ...
    key: "successOpen",
    value: function successOpen(card) {
    ...
    */
    ...
    value: function startTimer() {
      ...
      this.timerID = setInterval(function () {
        _this2.view.setTime(_this2.model.time++);
      }, 1000);
    }
  }]);
...
exports.default = _default;
},{"../Utils/Throttle":"assets/scripts/Utils/Throttle.js"}],"assets/scripts/Router/Router.js":[function(require,module,exports) {
"use strict";
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"assets/scripts/api.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function () {
  function StatisticController(view, router, model) {
...
function () {
  ...
  return ViewsStatistic;
}();

var _default = ViewsStatistic;
exports.default = _default;
...
var _ViewsStatistic = _interopRequireDefault(require("./View/ViewsStatistic"));
...
var routesEnum = [{
  ...
  component: function component(router, params) {
    var root = document.getElementById('app');
    new _StatisticController.default(new _ViewsStatistic.default(root), router, params);
  }
}];
new _Router.default(routesEnum);
},{"./View/View":"assets/scripts/View/View.js","./Model/Model":"assets/scripts/Model/Model.js","./Controller/Controller":"assets/scripts/Controller/Controller.js","./Router/Router":"assets/scripts/Router/Router.js","./View/ViewGameOver":"assets/scripts/View/ViewGameOver.js","./Controller/StatisticController":"assets/scripts/Controller/StatisticController.js","./View/ViewsStatistic":"assets/scripts/View/ViewsStatistic.js"}],"assets/scripts/index.js":[function(require,module,exports) {
"use strict";
...
require("./app");
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","../styles/index.scss":"assets/styles/index.scss","./app":"assets/scripts/app.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
